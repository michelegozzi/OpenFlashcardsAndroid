...
public class EmailLoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "michelegozzi@gmail.com:hello", "bar@example.com:world"
    };
    /**
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Intent myIntent = new Intent(EmailLoginActivity.this, TopicActivity.class);
                EmailLoginActivity.this.startActivity(myIntent);
            } else {
